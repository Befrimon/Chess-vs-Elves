...
const LEVEL_EXP = [0, 100, 600, 1600, 3100]
const ENTITY_PARAM = {
	## Elfs params
	"forest_elf": {
		"name": "Forest elf",
	...
	"king_figure": {
		...
		"level2": {"cost": 150, "hits": 1., "value": 50, "cooldown": 10},
		"level3": {"cost": 150, "hits": 2., "value": 50, "cooldown": 8},
		"level4": {"cost": 200, "hits": 2., "value": 75, "cooldown": 8},
		"level5": {"cost": 250, "hits": 3., "value": 100, "cooldown": 6}
	},
	"pawn_figure": {
		"name": "Pawn",
		"type": "attacker",
		"level1": {"cost": 50, "hits": 2., "value": -1., "cooldown": 1},
		"level2": {"cost": 100, "hits": 2., "value": -2., "cooldown": 1},
		"level3": {"cost": 100, "hits": 3., "value": -3., "cooldown": 1},
		"level4": {"cost": 150, "hits": 5., "value": -4., "cooldown": 1},
		"level5": {"cost": 200, "hits": 7., "value": -5., "cooldown": 1}
	}
}
